        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            {[
              ...
              <div key={index} className="slide-up text-center p-6 rounded-2xl transition-all duration-300" style={{ backgroundColor: 'rgba(0,0,0,0.4)', borderColor: stat.border, borderWidth: '1px', transitionDelay: `${0.4 + index * 0.1}s` }} onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 0 20px rgba(196,181,253,0.5), 0 0 40px rgba(196,181,253,0.3)'} onMouseLeave={(e) => e.currentTarget.style.boxShadow = 'none'}>
                <div className="w-14 h-14 rounded-xl flex items-center justify-center mx-auto mb-4 backdrop-blur-sm border" style={{ backgroundColor: 'rgba(0,0,0,0.5)', borderColor: stat.border }}>
            ...
            {/* Search and Filters */}
          <div className="slide-up rounded-2xl p-6 mb-8 backdrop-blur-xl border border-purple-500/20" style={{ backgroundColor: 'rgba(0,0,0,0.4)', transitionDelay: '0.8s' }}>
                  ...
                  <div className="space-y-3">
                    ...
                    <h4 className="text-sm font-medium text-white/80">Training Programs:</h4>
                      <div className="flex flex-wrap gap-2">
                        ...
                        <span className="px-3 py-1 rounded-full text-sm" style={{ backgroundColor: 'rgba(0,0,0,0.5)', color: '#c084fc' }}>
